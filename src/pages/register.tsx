...
export default function Register() {
  ...
  const inputConfirmPassword = useRef<any>(null);
      ...
      <form onSubmit={handleRegisterUser}>
        ...
        <div>
          <div className="container-input">
            ...
            <button onClick={() => handleClick(inputSenha.current.name)} type="button">
              {inputSenha.current?.type === 'text' ? eyeIcon.open : eyeIcon.close}
            </button>
          </div>
          <div className="container-input">
            <input
            ...
            <button onClick={() => handleClick(inputConfirmPassword.current.name)} type="button">
              {inputConfirmPassword.current?.type === 'text' ? eyeIcon.open : eyeIcon.close}
            </button>
          </div>
        </div>
